...
class BatchPreprocessor(object):
    ...
    def class_next_batch(self, num_per_class):
        ...
        ids = []
        for i in range(31):
            ids += np.random.choice(self.classpaths[i],
                                    size=num_per_class, replace=False).tolist()
            ...
            if self.multi_scale is None:
                ...
                if new_size != self.output_size[0]:
                    if self.istraining:
                        ...
                        img = img[starty:starty+self.output_size[0],
                                  startx:startx+self.output_size[1]]
            # Subtract mean color
